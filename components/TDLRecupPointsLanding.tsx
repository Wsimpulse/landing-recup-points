    ...
    <main className="min-h-screen bg-white text-slate-900">
      <div className="w-full bg-slate-900 text-white text-sm">
        <div className="mx-auto max-w-7xl px-4 py-2 flex items-center justify-between">
          <p className="font-medium">Numéro d’agrément : R2309300020 – Préfecture de Bobigny</p>
          <a href="tel:0180907249" className="underline underline-offset-2 hover:opacity-80">Appelez-nous : 01 80 90 72 49</a>
        </div>
      </div>
      ...
      <header className="sticky top-0 z-30 bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/60 border-b">
        <div className="mx-auto max-w-7xl px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="hidden sm:inline text-slate-500">• Récupération de points</span>
          </div>
          ...
          <div className="flex items-center gap-2">
            <a href="#reservation" className="px-4 py-2 rounded-xl bg-slate-900 text-white font-medium hover:opacity-90">Réserver</a>
          </div>
        </div>
      </header>
        ...
        <div className="relative mx-auto max-w-7xl px-4 pt-16 pb-14 grid lg:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <p className="mt-4 text-lg text-slate-700">
              Récupérez jusqu’à 4 points en 2 jours, dans notre centre d’Epinay-sur-Seine. Inscription en ligne simple et rapide.
            </p>
            <div className="mt-6 flex flex-col sm:flex-row gap-3">
              <a href="#reservation" className="px-5 py-3 rounded-2xl bg-slate-900 text-white font-semibold text-center">Réserver ma place</a>
              <a href="tel:0180907249" className="px-5 py-3 rounded-2xl border font-semibold text-center">Parler à un conseiller</a>
            </div>
            <div className="mt-6 flex items-center gap-6 text-sm text-slate-600">
              <div className="flex items-center gap-2"><span className="h-2.5 w-2.5 rounded-full bg-green-600" aria-hidden></span> Préfecture agréée</div>
              <div className="flex items-center gap-2"><span className="h-2.5 w-2.5 rounded-full bg-green-600" aria-hidden></span> Paiement 100% sécurisé</div>
              <div className="flex items-center gap-2"><span className="h-2.5 w-2.5 rounded-full bg-green-600" aria-hidden></span> 250€ le stage</div>
            </div>
          </div>
          <div className="lg:justify-self-end w-full">
            <div className="rounded-3xl border shadow-sm p-6 bg-white">
              ...
              <p className="text-slate-600 mt-1">Choisissez vos dates et finalisez en quelques clics.</p>
              <label className="block mt-4 text-sm font-medium">Dates disponibles</label>
              <select
              ...
              <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <a href="tel:0180907240" className="px-4 py-3 rounded-xl border font-medium text-center">Nous appeler</a>
              </div>
              <p className="text-xs text-slate-500 mt-3">En cliquant, vous serez redirigé vers notre module d’inscription sécurisé (Digiforma).</p>
            </div>
          </div>
        </div>
      </section>
          ...
          {[
            {
              ...
              a: "Tout conducteur titulaire d’un permis valide, n’ayant pas un solde de points nul, et respectant le délai d’un an et un jour entre deux stages.",
            },
            {
              q: "Combien de points récupérés ?",
              a: "Jusqu’à 4 points, dans la limite du plafond de votre permis.",
            },
            {
              q: "Quand sont crédités les points ?",
              a: "Dès le lendemain de la fin du stage. L’actualisation sur le fichier national peut prendre 1 à 3 mois selon les préfectures.",
            },
            {
              q: "Prix du stage ?",
              a: "250€ tout compris, paiement sécurisé en ligne.",
            },
          ].map((item) => (
      ...
      <section id="reservation" className="bg-slate-900 text-white">
        <div className="mx-auto max-w-7xl px-4 py-16 grid lg:grid-cols-2 gap-10 items-center">
          ...
          <div className="rounded-3xl bg-white/5 p-6">
            ...
            <address className="not-italic mt-2 text-slate-200">
              59, avenue Joffre, 93800 Epinay-sur-Seine
            </address>
